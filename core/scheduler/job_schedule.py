...
SCHEDULER_JOB_SPECS: tuple[SchedulerJobSpec, ...] = (
    SchedulerJobSpec(
        id="quarter_hour_job",
        label="Quarter hour",
        description="Import vodomeru, plynomeru, kalorimetru a manometru, scoring, eventy a alerting.",
    ...
    SchedulerJobSpec(
        ...
        description="SOFTLINK import, import elektromeru do monitoringu a meteo sync.",
    ...
    SchedulerJobSpec(
        ...
        label="SmartFuelPass weekly report job",
