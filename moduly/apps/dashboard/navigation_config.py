...
SECTIONS: tuple[DashboardSection, ...] = (
    ...
    DashboardSection(key="pronajem", label="Pronájem", icon="🏢", requires_device_permissions=False),
...
PAGES: tuple[DashboardPage, ...] = (
    ...
    DashboardPage(
        key="vodomery_list",
        path="pages/29_vodomery_seznam.py",
        title="Seznam",
        icon="📋",
        section_key="vodomery",
        configurable=True,
    ...
    DashboardPage(
        key="vodomery_reports",
        path="pages/27_vodomery_reporty.py",
        title="Reporty",
        icon="📈",
        section_key="vodomery",
        admin_only=True,
    ...
    DashboardPage(
        key="manometry_list",
        path="pages/30_manometry_seznam.py",
        title="Seznam",
        icon="📋",
        section_key="manometry",
        configurable=True,
    ...
    DashboardPage(
        key="plynomery_list",
        path="pages/31_plynomery_seznam.py",
        title="Seznam",
        icon="📋",
        section_key="plynomery",
        configurable=True,
    ...
    DashboardPage(
        key="plynomery_billing_readings",
        path="pages/34_plynomery_fakturacni_odecty.py",
        title="Fakturacni odecty",
        icon="🧾",
        section_key="plynomery",
        admin_only=True,
    ),
    ...
    DashboardPage(
        key="elektromery_list",
        path="pages/32_elektromery_seznam.py",
        title="Seznam",
        icon="📋",
        section_key="elektromery",
        configurable=True,
    ...
    DashboardPage(
        key="pronajem_map",
        path="pages/41_pronajem_mapa.py",
        title="Mapa - pronájem",
        icon="🗺",
        section_key="pronajem",
        configurable=True,
    ),
    DashboardPage(
