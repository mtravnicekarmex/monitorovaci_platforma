...
BUNDLE_FILE_SOURCES = (
    ...
    "monitoring_agent/delivery.py",
    "monitoring_agent/delivery_cli.py",
    "monitoring_agent/incident_store.py",
    "monitoring_agent/incidents.py",
    "monitoring_agent/interpretation.py",
    ...
    "monitoring_agent/reporting.py",
    "monitoring_agent/README.md",
    "monitoring_agent/runtime_delivery.py",
    "monitoring_agent/runtime_shadow.py",
    "monitoring_agent/settings.py",
    "monitoring_agent/shadow_pilot.py",
    "monitoring_agent/shadow_pilot_cli.py",
