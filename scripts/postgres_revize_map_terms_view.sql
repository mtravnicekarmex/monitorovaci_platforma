...
WITH sjednocene AS (
    SELECT
        ...
        v.revize_servisni_smlouva::text AS servisni_smlouva,
        v.revize_soubor::text AS revize_soubor,
        NULL::text AS foto,
    ...
    SELECT
        ...
        v.revize_servisni_smlouva::text,
        v.revize_soubor::text,
        v.foto::text,
        NULL::timestamp,
    ...
    SELECT
        ...
        v.patro::text,
        v.mistnost_id::text,
        COALESCE(NULLIF(v."místnost"::text, ''), NULLIF(v.mistnost::text, '')),
        v.identifikace::text,
        v.seriove_cislo::text,
        v."MBUS"::text,
        NULL::integer,
