-- Add canonical UTC interval metadata for PostgreSQL SmartFuelPass charge sessions.
--
-- Portal/source values in started_at and ended_at are intentionally kept as
-- legacy local civil timestamps. Canonical comparisons should use
