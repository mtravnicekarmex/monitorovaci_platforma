        ...
        datetime.date(2026, 3, 30): [
            {
                ...
                "device_hourly_rows": [
                    {"date": datetime.datetime(2026, 3, 30, 0, 0, 0), "identifikace": "A_V1", "spotreba": 5.0},
                    {"date": datetime.datetime(2026, 3, 30, 23, 0, 0), "identifikace": "A_V1", "spotreba": 4.0},
                    {"date": datetime.datetime(2026, 3, 30, 1, 0, 0), "identifikace": "B_V1", "spotreba": 3.0},
                ],
            }
        ],
        datetime.date(2026, 3, 31): [
            {
                ...
                "device_hourly_rows": [
                    {"date": datetime.datetime(2026, 3, 31, 22, 0, 0), "identifikace": "A_V1", "spotreba": 4.0},
                    {"date": datetime.datetime(2026, 3, 31, 2, 0, 0), "identifikace": "C_V1", "spotreba": 6.0},
                ],
            }
        ],
    }
